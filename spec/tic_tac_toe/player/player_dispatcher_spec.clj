(ns tic-tac-toe.player.player-dispatcher-spec
  (:require [speclj.core :refer :all]
            [tic-tac-toe.player.player-dispatcher :as d]
            [tic-tac-toe.player.unbeatable-ai :refer [->unbeatable-ai]]
            [tic-tac-toe.player.random-ai :refer [->random-ai]]
            [tic-tac-toe.player.medium-bot :refer [->medium-bot]]
            [tic-tac-toe.player.randomly-blocking-ai :refer [->randomly-blocking-ai]]
            [tic-tac-toe.player.advanced-blocking-ai :refer [->advanced-blocking-ai]]))

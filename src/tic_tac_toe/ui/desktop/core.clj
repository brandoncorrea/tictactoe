(ns tic-tac-toe.ui.desktop.core
  (:require [quil.core :as q]
            [quil.middleware :as m]
            [tic-tac-toe.ui.desktop.pages.page :as p]
            [tic-tac-toe.ui.desktop.pages.new-game]
            [tic-tac-toe.ui.desktop.pages.play]
            [tic-tac-toe.ui.desktop.pages.game-over]
            [tic-tac-toe.ui.desktop.pages.load-game]
            [tic-tac-toe.ui.desktop.components.mouse :as mouse]
